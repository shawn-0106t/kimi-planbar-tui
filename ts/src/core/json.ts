...
const hexDigit = (n: number): string => "0123456789abcdef"[n & 0xf];
...
export const jIsNull = (v: JValue | undefined): v is { kind: "null" } => v?.kind === "null";
export const jIsObject = (v: JValue | undefined): v is { kind: "obj" } => v?.kind === "obj";
export const jIsArray = (v: JValue | undefined): v is { kind: "arr" } => v?.kind === "arr";
