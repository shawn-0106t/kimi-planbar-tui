...
> **版本说明**：`rust/`（Rust 版）为持续维护的推荐版本；`ts-nodejs/`（Node 版）与 `ts/`（Bun 版）是界面与行为一致的受支持替代版，各自独立升版（Bun 版曾于 2026-09-19 至 2026-09-25 冻结为实验性，2026-09-25 解冻以落地独占控制台启动崩溃修复——见 `HANDOFF.md`）。
...
> 2026-09-25 解冻（此前为实验性冻结），恢复为受支持替代版本并独立升版。
